...
class TestFan:
    ...
    def run_test(self):
        ...
        print("\033[91mThe First Fan has the following properties: ")
        print("\033[92mSpeed:" , first_fan.get_speed())
        print("\033[95mRadius:", first_fan.get_radius())
        print("\033[93mColor:", first_fan.get_color())
        print("\033[97mIs the fan on?:", first_fan.is_on())

        # recognize the command of second fan and print the output
        print("\033[91mThe Second Fan has the following properties: ")
        print("\033[96mSpeed:", second_fan.get_speed())
        print("\033[92mRadius:", second_fan.get_radius())
        print("\033[94mColor:", second_fan.get_color())
        print("\033[97mIs the fan on?:", second_fan.is_on())
